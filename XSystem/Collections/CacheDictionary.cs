...
namespace XSystem.Collections
{
    ...
    public class CacheDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        /// </returns>
        public ICollection<TValue> Values => this.mInternal.Values;
        ...
        ///     <see cref="T:System.Collections.Generic.IDictionary`2" />.
        /// </returns>
        public ICollection<TKey> Keys => this.mInternal.Keys;

        /// <summary>
        ///     Gets the number of elements contained in the <see cref="T:System.Collections.Generic.ICollection`1" />.
        /// </summary>
        /// <returns>The number of elements contained in the <see cref="T:System.Collections.Generic.ICollection`1" />.</returns>
        public int Count => this.mInternal.Count;
        ...
        ///     <paramref name="pKey" /> was not found in the original <see cref="T:System.Collections.Generic.IDictionary`2" />.
        /// </returns>
        public bool Remove(TKey pKey)
        {
            var lResult = this.mInternal.Remove(pKey);
            if (lResult)
            {
                this.mLatestKeys.Remove(pKey);
            }
        ...
        ///     otherwise, the default value for the type of the <paramref name="pValue" /> parameter. This parameter is passed
        ///     uninitialized.
        /// </param>
        /// <returns>
        ...
        /// <returns>
        ///     true if <paramref name="pItem" /> is found in the <see cref="T:System.Collections.Generic.ICollection`1" />;
        ///     otherwise, false.
        /// </returns>
