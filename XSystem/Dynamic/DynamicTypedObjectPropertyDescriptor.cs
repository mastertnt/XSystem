...
{
    /// <summary>
    ///     This class is used to build a new property descriptor attached to a dynamic typed object
    ///     <see cref="DynamicTypedObject" />
    /// </summary>
    public class DynamicTypedObjectPropertyDescriptor : PropertyDescriptor
    {
        ...
        /// </summary>
        public override Type ComponentType => typeof(DynamicTypedObject);

        /// <summary>
        ///     Returns the type of the property.
        /// </summary>
        public override Type PropertyType => this.mPropertyType;
        ...
        public DynamicTypedObjectPropertyDescriptor(PropertyDescriptor pDescriptor) : base(pDescriptor)
        {
        ...
        public DynamicTypedObjectPropertyDescriptor(string pPropertyName, Type pPropertyType, Attribute[] pAttributes = null) : base(pPropertyName, pAttributes)
        {
        ...
        {
            var lObject = pComponent as DynamicTypedObject;
            if (lObject != null)
            {
                object lResult = null;
